...
function Register() {
  ...
  const profileImageRegister = register("profileImageUrl", {
    validate: {
      fileType: (files) => {
  ...
  const onUserRegister = async (userObj) => {
    ...
    try {
      ...
      let res = await axios.post("https://blog-app-1wnj.onrender.com/auth/users", formData, { withCredentials: true });
        ...
        <form onSubmit={handleSubmit(onUserRegister)}>
          ...
          <div className={formGroup}>
            ...
            <input
              ...
              onChange={(event) => {
                profileImageRegister.onChange(event);
